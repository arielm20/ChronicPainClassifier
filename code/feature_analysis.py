...
class feature_analysis:
    ...
    def plot_rel_comparisons(self):
        ...
        for band in self.frequency_bands.keys():
            rel_cols = [col for col in self.data.columns if f'{band}_total_rel' in col]
            if rel_cols:
    ...
    def plot_regional_comparisons(self):
        ...
        for region in self.regions:
            ...
            plot_data = []
            for band in self.frequency_bands.keys():
                regional_cols = [col for col in self.data.columns if region in col and band in col]
    ...
    def plot_TAR_analysis(self):
        ...
        for i, col in enumerate(tar_cols[:]):
...
if __name__ == "__main__":
    feature_analysis().run_full_analysis()